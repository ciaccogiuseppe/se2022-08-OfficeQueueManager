            ...
            <Grid containers item sm>
                <form onSubmit={handleSubmit}>
                    <Grid containers item sm marginTop={3}>
                        <TextField id="filled-input" label="Service ID" type="number" variant="filled" onChange={e => setServiceID(e.target.value)}/>
                    </Grid>
                    <Grid containers item sm marginTop={3}>
                        <TextField id="filled-input" label="Service description" variant="filled" onChange={e => setServiceDescription(e.target.value)}/>
                    </Grid>
                    <Grid containers item sm marginTop={3}>
                        <TextField id="filled-input" type="number" label="Estimated time (in minutes)" variant="filled" onChange={e => setServiceTime(e.target.value)}/>
                    </Grid>
